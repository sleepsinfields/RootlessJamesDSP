...
extern void BassBoostSetTargetFs(JamesDSPLib *jdsp, double targetFs);
...
extern void BassBoostSetAdvanced(
    JamesDSPLib *jdsp,
    float maxG,
    float widthNorm,
    int typeInt,
...
extern void VTProcess(VacuumTube *tb, float *x1, float *x2,
                      float *out1, float *out2, size_t n);
...
extern void VacuumTubeSetTriodeParams(JamesDSPLib *jdsp, double drive, double bias, double scale);

// NEW:
extern void VacuumTubeSetCoreTriode(JamesDSPLib *jdsp, int enabled);
