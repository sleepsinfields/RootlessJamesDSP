...
double harmonic2Ch1 = bandCh1[1] * bandCh1[1] * bandCh1[1];
double harmonic3Ch1 = bandCh1[2] * bandCh1[2] * bandCh1[2];
double harmonic4Ch1 = bandCh1[3] * bandCh1[3] * bandCh1[3];
double harmonic5Ch1 = bandCh1[4] * bandCh1[4] * bandCh1[4];
double allpassCh2 = bandCh2[1] + bandCh2[2] + bandCh2[3] + bandCh2[4];
double harmonic2Ch2 = bandCh2[1] * bandCh2[1] * bandCh2[1];
double harmonic3Ch2 = bandCh2[2] * bandCh2[2] * bandCh2[2];
double harmonic4Ch2 = bandCh2[3] * bandCh2[3] * bandCh2[3];
double harmonic5Ch2 = bandCh2[4] * bandCh2[4] * bandCh2[4];
